...
import (
	...
	"github.com/jwayong/secret-detector/pkg/detectors/artifactory"
	"github.com/jwayong/secret-detector/pkg/detectors/aws"
	"github.com/jwayong/secret-detector/pkg/detectors/azure"
	"github.com/jwayong/secret-detector/pkg/detectors/basicauth"
	"github.com/jwayong/secret-detector/pkg/detectors/bearerauth"
	"github.com/jwayong/secret-detector/pkg/detectors/generic"
	"github.com/jwayong/secret-detector/pkg/detectors/github"
	"github.com/jwayong/secret-detector/pkg/detectors/jwt"
	"github.com/jwayong/secret-detector/pkg/detectors/keyword"
	"github.com/jwayong/secret-detector/pkg/detectors/mailchimp"
	"github.com/jwayong/secret-detector/pkg/detectors/npm"
	"github.com/jwayong/secret-detector/pkg/detectors/privatekey"
	"github.com/jwayong/secret-detector/pkg/detectors/sendgrid"
	"github.com/jwayong/secret-detector/pkg/detectors/slack"
	"github.com/jwayong/secret-detector/pkg/detectors/square"
	"github.com/jwayong/secret-detector/pkg/detectors/stripe"
	"github.com/jwayong/secret-detector/pkg/detectors/twilio"
	"github.com/jwayong/secret-detector/pkg/transformers/initransformer"
	"github.com/jwayong/secret-detector/pkg/transformers/jsontransformer"
	"github.com/jwayong/secret-detector/pkg/transformers/xmltransformer"
	"github.com/jwayong/secret-detector/pkg/transformers/yamltransformer"
)
